...
urlpatterns = [
    ...
    path('book/<int:pk>/delete/', views.BookDelete.as_view(), name='book-delete'),
        path("catalog/adaptations/", views.AdaptationListView.as_view(), name="adaptations"),
    path("catalog/adaptation/<int:pk>/", views.AdaptationDetailView.as_view(), name="adaptation-detail"),
]
